...
const Register = () => {
  ...
  // --- NEW: Added state for input fields ---
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Save their Role and Name to Firestore (The Database)
      ...
      // OPTIONAL: Success alert to confirm it worked
      ...
      >
        ...
        >
          <div className="space-y-8 text-left">
            <h1 className="font-headline text-5xl font-extrabold leading-tight tracking-tight text-left">
              Setup your <span className="text-[#0c56d0]">predictive</span>{" "}
              terminal.
            </h1>
            <p className="text-lg text-[#586064] max-w-md text-left">
              Connect your IoT hardware to the cloud and eliminate run-out
              anxiety forever.
            </p>
            <div className="grid grid-cols-1 gap-6 pt-8">
              {[
                {
                  title: "IoT Sync",
                  desc: "Securely link your ESP32-driven scale.",
                  icon: "sync",
                  color: "bg-[#dae2ff] text-[#0c56d0]",
                },
                {
                  title: "Level Prediction",
                  desc: "Predictive analytics.",
                  icon: "query_stats",
                  color: "bg-[#e4e2e6] text-[#5f5f62]",
                },
                {
                  title: "Safety Protocol",
                  desc: "Encrypted telemetry.",
                  icon: "encrypted",
                  color: "bg-[#e3dbfd] text-[#615b77]",
                },
              ].map((prop, i) => (
                <div
                  key={i}
                  className="p-6 bg-white rounded-xl flex items-start gap-4 border border-[#abb3b7]/15"
                >
                  <div
                    className={`p-3 rounded-lg flex items-center justify-center ${prop.color}`}
                  >
                  ...
                  <div className="text-left">
                    <h3 className="font-headline font-bold text-[#2b3437]">
                      {prop.title}
                    </h3>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 text-left">
                  <label className="text-sm font-semibold text-[#586064] uppercase text-[11px]">
                    Full Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="space-y-2 text-left">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-[#abb3b7]"
                  >
