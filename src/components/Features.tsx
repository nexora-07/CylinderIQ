...
const Features = () => {
  return (
    // Responsive padding: tighter on mobile (py-16 px-6)
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-8 md:space-y-10 text-left">
            {[
              { id: 1, title: "Map view", desc: "Interactive 3D geospatial dashboard that visualizes the physical movement of your assets across borders." },
              { id: 2, title: "Automated reporting", desc: "Schedule detailed compliance and inventory reports delivered directly to your stakeholders weekly." },
              { id: 3, title: "Enterprise security", desc: "Biometric access controls for fleet operators and encrypted data transmission for all IoT sensors." }
            ].map((feature, index) => (
              <motion.div 
                key={feature.id}
        ...
        {/* Right Column: Map & Floating Card */}
        <div className="lg:w-1/2 w-full h-[400px] sm:h-[500px] md:h-[600px] relative">
          ...
          >
            ...
            {/* The Floating Overlay Card: Responsive padding and positioning */}
            <motion.div 
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-0">
                <div>
                  <p className="text-xs md:text-sm font-bold text-[#0c56d0] mb-1 font-body">Active Distribution</p>
                  <p className="text-2xl md:text-3xl font-black text-[#2b3437] font-headline">4,829 Units</p>
                </div>
                <div className="text-left sm:text-right w-full sm:w-auto">
                  <p className="text-xs md:text-sm font-bold text-green-600 mb-2 font-body">Optimal Status</p>
